...
SubDAO rewards are calculated and paid to the lock-up position each 24-hr reward period, at
...
- Your delegated veHNT decays over time after you entered cooldown (cliff mode).
